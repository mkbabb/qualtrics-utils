...
SURVEYS_RESPONSE_IMPORT_EXPORT_URL="https://stoplight.io/api/v1/projects/qualtricsv2/publicapidocs/nodes/reference/singleResponses.json\?fromExportButton\=true\&snapshotType\=http_service"

# array of urls to download
URLS=($SINGLE_SURVEY_RESPONSE_URL $SURVEYS_RESPONSE_IMPORT_EXPORT_URL)
